		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#docmgtstandalone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"docmgtstandalone-display": {
								"semanticObject": "docmgtstandalone",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=docmgtstandalone",
									"url": sap.ui.require.toUrl("docmgtstandalone")
								}
							}
						}
					}
